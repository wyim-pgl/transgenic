...
from configuration_transgenic import T5HyenaConfig
from safetensors.torch import save_model
from modeling_HeynaTransgenic import transgenicForConditionalGenerationT5
...
if __name__ == '__main__':
	...
	trainTransgenicFCGAccelerate(
		...
		batch_size=1, 
		accumulation_steps=32,
		checkpoint_path="checkpoints_T5Hyena/", 
		safetensors_model=None,
		output_dir="saved_models_T5Hyena/",
		max_grad_norm=1,
		notes="Training with T5 and Hyena",
		encoder_model="LongSafari/hyenadna-large-1m-seqlen-hf",
		unlink = False,
		log_wandb=True
	)