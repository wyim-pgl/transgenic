...
""" Transgenic model configuration"""
...
class TransgenicConfig(PretrainedConfig):
	r"""
...
class TransgenicHyenaConfig(PretrainedConfig):
	r"""
	This is the configuration class to store the configuration of a [`transgenicModel`]. It is used to instantiate an Transgenic
	model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
	defaults will yield a similar configuration to that of the LED
...
class TransgenicT5Config(PretrainedConfig):
	def __init__(
			self,
			classifier_dropout = 0.0,
			d_ff = 2048,
...
class T5HyenaConfig(PretrainedConfig):
	def __init__(
			self,
			classifier_dropout = 0.0,
			d_ff = 2048,
