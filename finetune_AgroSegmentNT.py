...
if __name__ == '__main__':
	...
	ds  = segmentationDataset(12288, 11000, "Segmentation_7Genomes.db")
	train_data, eval_data, test_data = torch.utils.data.random_split(ds, [231003, 30800, 46202])
	...
	trainSegmentNTAccelerate(
		...
		max_grad_norm=2,
		notes="Direct fine tuning of agro SegmentNT",
