...
decoder_checkpoint =  "checkpoints_Gen9G_Large/model.safetensors"#"checkpoints/transgenic_Gen10G_6144nt_E4.safetensors" # "checkpoints_Gen10G/model.safetensors"
segment_checkpoint = "checkpoints/AgroSegmentNT_Epoch1-5_6144nt_restart_codons.safetensors" #model.safetensors"

config = TransgenicConfig(do_segment=True, vocab_size=50262)
...
eval_data = makeDataLoader(eval_data, shuffle=True, batch_size=1, pin_memory=True, num_workers=4, collate_fn=target_collate_fn)
